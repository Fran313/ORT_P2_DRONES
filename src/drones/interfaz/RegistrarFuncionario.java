...
public class RegistrarFuncionario extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    pnlIngresoDatos.setPreferredSize(null);
    ...
    pnlDatosFuncionarios.setPreferredSize(null);
    ...
    javax.swing.GroupLayout pnlDatosFuncionariosLayout =
        new javax.swing.GroupLayout(pnlDatosFuncionarios);
    pnlDatosFuncionarios.setLayout(pnlDatosFuncionariosLayout);
    pnlDatosFuncionariosLayout.setHorizontalGroup(
        pnlDatosFuncionariosLayout
            ...
            .addGroup(
                ...
                pnlDatosFuncionariosLayout
                    ...
                    .addComponent(
                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 1188, Short.MAX_VALUE)
                    .addContainerGap()));
  ...
  public void hydrate() {
    ...
    for (int i = 0; i < funcionarios.size(); i++) {
      String[] row = {
        funcionarios.get(i).getNombre(),
        String.valueOf(funcionarios.get(i).getEdad()),
        String.valueOf(funcionarios.get(i).getNumero())
      };
      tblModel.addRow(row);
    }
